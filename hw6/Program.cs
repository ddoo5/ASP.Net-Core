...
using ContractControlCentre.Validation.Services;
...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1.0.6", new OpenApiInfo
    {
        Version = "v1.0.6",
...
builder.Services.AddSingleton<IVValidationService, ValidationService>();
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1.0.6/swagger.json", "CCC (Contract Control Centre)");
});
