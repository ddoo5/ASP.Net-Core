...
namespace ContractControlCentre.Service
{
    public class EmployeeService
    {
        ...
        public EmployeeService(ILogger<EmployeeService> logger, IEmployeeRepository employeeRepo, IAuthenticationService authenticationService, IVValidationService validation)
        {
            this._logger = logger;
